...
class PolicyMakeCommandTest extends MakeTest
{
    ...
    public function testWithModule () : void
    {
        ...
        $response = $this->artisan("make:policy", ["name" => $policy = "MyNewPolicy", "--module" => $module = "MyModule"]);
    ...
    {
        $stub = realpath(__DIR__ . "/../../../vendor/laravel/framework/src/Illuminate/Foundation/Console/stubs/policy.plain.stub");
