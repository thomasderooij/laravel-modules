...
class GetAvailableModulesTest extends DependencyHandlerTest
{
    ...
    public function testGettingAvailableModulesForUpstream(): void
    {
        ...
        $this->methodHandler->shouldReceive("getDownstreamModules")->andReturn(
            [$this->downstreamModule, $this->blueCollarModule]
        );
        ...
        $expected = $this->alphabeticalByValues(
            [$this->moduleInBetween, $this->unrelatedModule, $this->unrelatedModule2]
        );
        $this->assertSame(
            $expected,
            $this->alphabeticalByValues($this->uut->invoke($this->methodHandler, $this->upstreamModule))
        );
    }
    ...
    public function testGettingAvailableModulesForModuleInBetween(): void
    {
        ...
        $this->assertSame(
            $expected,
            $this->alphabeticalByValues($this->uut->invoke($this->methodHandler, $this->moduleInBetween))
        );
    }
    ...
    public function testGettingAvaiableModulesForBlueCollar(): void
    {
        ...
        $this->assertSame(
            $expected,
            $this->alphabeticalByValues($this->uut->invoke($this->methodHandler, $this->blueCollarModule))
        );
    }
    ...
    public function testGettingAvaiableModulesForDownstream(): void
    {
        ...
        $this->assertSame(
            $expected,
            $this->alphabeticalByValues($this->uut->invoke($this->methodHandler, $this->downstreamModule))
        );
    }
    ...
    public function testGettingAvailableModulesForUnrelatedModule(): void
    {
        ...
        $expected = $this->alphabeticalByValues(
            [
                ...
                $this->unrelatedModule2
            ]
        );
        $this->assertSame(
            $expected,
            $this->alphabeticalByValues($this->uut->invoke($this->methodHandler, $this->unrelatedModule))
        );
    }
        ...
        $this->methodHandler->shouldReceive("getTrackerContent")->andReturn(
            $trackerContent = [
                "modules" => $modules = [
                    ...
                    $unrelatedModule = "unrelated_module",
                    $unrelatedModule2 = "unrelatedModule"
                ],
                "activeModules" => [],
